...
the color to red and also change the background color to yellow.
Solution:
<html>
<head>
<title>slip 1</title>
...
Slip 3:
Write a program using html with following CSS specificationsi. The background colour of the company name should be in green.
...
List of Books
Item No Item Name PriceRs. Paise1 Programming in Python 500 502 Programming in Java 345 00
<html>
<body>
<table border = 1>
...
background color red, add address of college.
<html>
<head>
<link rel="stylesheet" href="bootstrap.min.css">
<title>NRC</title>
